<%@ Page Title="" Language="C#" MasterPageFile="~/IntegrantesMaster.Master" AutoEventWireup="true" CodeBehind="Lideres.aspx.cs" Inherits="Networks.Lideres" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">    
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <table>
       <tr>
           <td colspan="2" class="title space">Agregar Líder</td>
       </tr>
       <tr>
       ...
       <tr>
           <td class="space">Territorial:</td>
           <td>
               <asp:DropDownList runat="server" ID="DpTerr"></asp:DropDownList>
           </td>
       </tr>
       <tr>
     ...
     <%if(Saved == false)
         { %>
       <tr>
           <td colspan="2" style="color:red">No se guardo el líder seguramente ya existe.</td>
       </tr>   
       <%} %>
       <tr>
           <td colspan="2">
