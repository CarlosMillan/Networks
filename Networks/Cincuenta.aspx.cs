...
namespace Networks
{
    public partial class Cincuenta : System.Web.UI.Page
    {
        ...
        {
            C = new CIntegrantes(CIntegrantes.TypeIntegrante.L50);            
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            ReloadIntegrantsTable(C.Search50(CriteriosList.ToArray()));
        }
    }
}