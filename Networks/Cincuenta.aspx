<%@ Page Title="" Language="C#" MasterPageFile="~/IntegrantesMaster.Master" AutoEventWireup="true" CodeBehind="Cincuenta.aspx.cs" Inherits="Networks.Cincuenta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <table class="Data">
       <tr>
           <td colspan="4" class="title space">Agregar a "Los 50"</td>
       </tr>
       <tr>
       ...
       <%} %>
        <asp:DataGrid CssClass="space" AutoGenerateColumns="true" runat="server" ID="Dgrid50"  AlternatingItemStyle-BackColor="#FAEBD7">
