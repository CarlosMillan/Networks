<%@ Page Title="" Language="C#" MasterPageFile="~/IntegrantesMaster.Master" AutoEventWireup="true" CodeBehind="Cincuenta2.aspx.cs" Inherits="Networks.Cincuenta2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <table class="Data">
       <tr>
           <td colspan="4" class="title space">Agregar a "Los Segundos 50"</td>
       </tr>
       <tr>
       ...
       <%} %>
        <asp:DataGrid CssClass="space" AutoGenerateColumns="true" runat="server" ID="Dgrid50_2"  AlternatingItemStyle-BackColor="#FAEBD7">
